...
export async function fetchProducts(searchTerm: string = "", category: string | null = null, color: string | null = null, offset: number = 0, limit: number = 12, isServer : boolean = false): Promise<FetchProductsResponse> {
  const url = isServer
